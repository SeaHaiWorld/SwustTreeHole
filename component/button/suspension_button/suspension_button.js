  ...
  properties: {
    theme: {
      ...
      observer: function (newVal) {
        ...
        const endColor = this.properties.endColor;
        const themes = {
          // default: `border-radius: 100%; background-color: ${color}`,
          default:`border-radius: 100%; background-color: ${color}; box-shadow: 0 8rpx 40rpx ${color};`,
    ...
    src: {
      type: String,
      value: 'https://tree-home-1259219507.cos.ap-chengdu.myqcloud.com/%E5%9B%9B%E5%8F%B6%E8%8D%89.png'
    },
    imgMargin: {
      type: String,
      value: '15'
